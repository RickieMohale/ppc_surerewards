...
st.markdown("<h3 style='text-align: center; color: red;'>  </h3>", unsafe_allow_html=True)
...
"series": [{"name":'No Of Bags',"type": 'line',"stack": 'Total',"areaStyle": {},"emphasis": {"focus": 'series'},
...
region_sum_chart= {"title": {"text": 'Performace By Total Number of Bags ',"left": 'center'},"tooltip": {"trigger": 'item', "formatter": '{a} <br/>{b} : {c} ({d}%)' },"toolbox": {"show": "true","feature": {"mark": { "show": "true" },"dataView": { "show": "true", "readOnly": "false" },
...
region_chart= {"title": {"text": 'Performance By Sales Frequency',"left": 'center'},"tooltip": {"trigger": 'item', "formatter": '{a} <br/>{b} : {c} ({d}%)' },"toolbox": {"show": "true","feature": {"mark": { "show": "true" },"dataView": { "show": "true", "readOnly": "false" },
"restore": { "show": "true" }}}, "series": [ { "name": 'Sales Frequency', "type": 'pie', "radius": [50, 100],"center": ['50%', '50%'],
